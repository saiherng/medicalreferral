  ...
  <body>
    ...
    <section style="background-image: url(wallpaper.jpeg); background-repeat: no-repeat; background-size: cover;">
      ...
      <h1>Sending Message</h1>
        ...
        <form autocomplete="off" action="replyMessageAction.php" method="post">
          <!-- <label for="name">Name:</label>
          <input type="text" id="name" name="name" value=""><br><br>-->
          <input type="hidden" id="to_email" name="to_email" value="<?php echo "$from_email" ?>">
          
          <label for="name">Name:</label>
          <input type="text" id="name" name="name" value='<?php
                   echo "$name"; ?>' >         
      
          <input type="hidden" id="from_email" name="from_email" value='<?php
                   echo "$to_email"; ?>' >
                   <br><br>
          ...
          <textarea id="message" name="message" rows="10" cols="90"></textarea><br><br>
